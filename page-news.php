								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="events-space">
											<?php  echo do_shortcode('[events_list limit="10" scope="2-months" category=53]<div class="col-xs-3"><p class="event-date-day">#d</p><p class="event-date-month">#M</p></div><div class="col-xs-9"><h5 class="event-title">#_EVENTLINK</h5><p class="event-date-times"><b>#l - #_EVENTTIMES</b></p></div><div class="clearfix"></div><hr />[/events_list]') ?>
